...
sns.pairplot(df)
Out[ ]:
<seaborn.axisgrid.PairGrid at 0x7fae33dfa810>
...
Out[ ]:
<matplotlib.axes._subplots.AxesSubplot at 0x7fae2a29b650>
...
Out[ ]:
<seaborn.axisgrid.JointGrid at 0x7fae2858f1d0>
...
Out[ ]:
<seaborn.axisgrid.FacetGrid at 0x7fae2a361fd0>

In [ ]:
sns.lmplot(x='LSTAT', y='MEDV',data=df)
Out[ ]:
<seaborn.axisgrid.FacetGrid at 0x7fae2847c610>

In [ ]:
sns.lmplot(x='LSTAT', y='RM',data=df)
Out[ ]:
<seaborn.axisgrid.FacetGrid at 0x7fae28326b90>
